...
# pentru training files

# Specifică directorul de intrare cu fișiere PCAP
input_folder = "../InputData/train"
output_folder = "../InputData/train.json"
...
# 'x.pcap' este transformat in 'x.json' si mutat in folderul train.json, nou creat in InputData
